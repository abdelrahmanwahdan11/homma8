...
class _WantedBoardPageState extends State<WantedBoardPage> {
  ...
  Widget build(BuildContext context) {
    final categories = ['All', 'phones', 'laptops', 'gaming', 'collectibles'];
    final appState = AppStateScope.of(context);
    return Scaffold(
      appBar: AppBar(title: const Text('Wanted board')),
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: categories.map((category) {
                    ...
                    final selected = _category == null && category == 'All' || _category == category;
