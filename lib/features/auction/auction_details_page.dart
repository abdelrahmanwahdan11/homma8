                      ...
                      children: [
                        ...
                        TweenAnimationBuilder<double>(
                          ...
                          builder: (context, value, _) {
                            return Text('Current bid: ${value.toStringAsFixed(0)} USD',
                                ...
                                builder: (_) => PlaceBidModal(
                                  ...
                                  onSubmit: (amount) async {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(content: Text('Bid placed: ${amount.toStringAsFixed(0)}')),
                                    );
                                  },
                                ),
                              ),
                            ...
                            OutlinedButton(
                              onPressed: () => showModalBottomSheet<void>(
                                ...
                                builder: (_) => AiInfoSheet(
                                  summary: 'AI summary: ${auction.title} with lime aesthetic ready for industrial setups.',
                        ...
                        Column(
                          children: List.generate(5, (index) {
                            return ListTile(
                              ...
                              title: Text('Bidder #$index'),
                              subtitle: const Text('Mock timestamp'),
                              trailing: Text('${(auction.priceNow - index * 5).toStringAsFixed(0)} USD'),
                            );
                          }),
                        ),
                      ],
